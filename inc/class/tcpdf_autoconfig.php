...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'comment.gif')) {
		$tcpdf_header_logo = 'comment.gif';
	}
...
if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'Makmesh iKiev <makmesh.x@gmail.com>');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Makmesh Payroll (Kenya)');
}
